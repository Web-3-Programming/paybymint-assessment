        ...
        <div className="mb-24 flex flex-col md:flex-row gap-y-9">
          <div className="flex flex-col flex-1 items-start justify-start" >
            ...
            <div className="flex items-center text-lg justify-around md:justify-start w-full md:w-auto">
              ...
              <Link href="/create-item" passHref><Button className="py-4 ml-0 whitespace-nowrap md:ml-6 bg-white border border-solid px-10 md:px-14 rounded-3xl text-orange border-orange">Get Started</Button></Link>
            </div>
          </div>
